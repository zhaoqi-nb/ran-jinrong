...
class CustomTab extends Component {
    ...
    queryComponentData = async () => {
        ...
        // debugger;
        this.setState({ instantiationId, download, templateData, currSelect, tabData, type, controlledElement, effectElement, style, componentState, conditionShow }, () => {
    ...
    renderContent = () => {
        const { instantiationId, tabData, type, style, conditionShow, controlledElement } = this.state;
        let { currSelect, download } = this.state
        const { children, bodyStyle = {}, position, className, containerStyle, onObserver, onChange } = this.props;
