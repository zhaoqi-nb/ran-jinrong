        ...
        <div>
            <Panel title='下载内容'>
                <Panel.Vertical title='类型'>
                    <CustomCheckbox id='11420' />
                </Panel.Vertical>
            </Panel>

            <Panel title='时间周期'>
                <Panel.Vertical title='周期'>
                    <Custom_Date id='11421' />
                </Panel.Vertical>
            </Panel>

            <Panel title='筛选条件'>
                <div>
                    <CustomSelect select_style={{width: 250}} id='11422' />
                </div>
                {/* <Panel.Vertical style title='行业'>
                    <MultiSelect industryList={industryList} />
                </Panel.Vertical> */}
                <div style={{display: 'none'}}>
                    <CustomSelect select_style={{width: 350}} id='11423' />
                </div>
                <CustomSelect select_style={{width: 220}} id='11424' />
          ...
          <CustomSelect select_style={{width: 350}} id='11340' />
            ...
            <Panel title='指标选择'>
                <Panel.Vertical title='指标'>
                    <Filter id='11425' downloadChange={onChange} ref={filterRef} />
                </Panel.Vertical>
            </Panel>
