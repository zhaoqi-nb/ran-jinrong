    ...
    render() {
        ...
        return (
            <div >
                ...
                <Custom_Date id='510' style={{marginRight: '16px', marginTop: 0}} select_style={{width: `${i18n.getLocalLanguage()==='zh_CN'?'175px':'280px'}`}}/>
                <CustomSelect id='511' />
                <div style={{ display: 'flex', alignItems: 'center', margin: '8px 0', borderBottom: '1px solid #E1E8F0'}}>
                    <CompanyTitle id='512' />
                    {/* <UpdateTime style={{ marginLeft: '16px' }} id='513' /> */}
                </div>
                <Chart id='514' />
                <CustomTable id='515' />
            </div>
